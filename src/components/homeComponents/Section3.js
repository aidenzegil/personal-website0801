        ...
        <div class="column is-two-fifths block m-auto">
          <div class="box" style={{ height: "100%" }}>
            ...
            <h2 class="subtitle block p-4">
              Most of what I've done is Front End. I work mostly in react but I
              have tried out Vue.js and I gotta say I kind of like it, not
              enough to casually make the switch from React.js but enough that I
              wouldn't mind if I had to.
            </h2>
        ...
        >
          <div class="box" style={{ height: "100%" }}>
            ...
            <div class="is-left block">
              ...
              <progress class="progress level-item is-warning is-small" value="35" max="100">
                80%
              </progress>
            </div>
            <div class="is-left">
                <h1 class="is-left">Git</h1>
              <progress class="progress level-item is-success is-small" value="75" max="100">
                80%
              </progress>
            </div>
          </div>
